...
l=/^(.+?)eed$/,n=/^(.+?)(ed|ing)$/,t=/.$/,y=/(at|bl|iz)$/,u=/([^aeiouylsz])\1$/,q=/^[^aeiou][^aeiouy]*[aeiouy][^aeiouwxy]$/,v=/^(.+?[^aeiou])y$/,z=/^(.+?)(ational|tional|enci|anci|izer|bli|alli|entli|eli|ousli|ization|ation|ator|alism|iveness|fulness|ousness|aliti|iviti|biliti|logi)$/,A=/^(.+?)(icate|ative|alize|iciti|ical|ful|ness)$/,F=/^(.+?)(al|ance|ence|er|ic|able|ible|ant|ement|ment|ent|ou|ism|ate|iti|ous|ive|ize)$/,D=/^(.+?)(s|t)(ion)$/,B=/^(.+?)e$/,E=/ll$/,C=/^[^aeiou][^aeiouy]*[aeiouy][^aeiouwxy]$/,
x=function(c){if(3>c.length)return c;var w=c.substr(0,1);"y"==w&&(c=w.toUpperCase()+c.substr(1));var p=h;var m=k;p.test(c)?c=c.replace(p,"$1$2"):m.test(c)&&(c=c.replace(m,"$1$2"));p=l;m=n;if(p.test(c))m=p.exec(c),p=d,p.test(m[1])&&(p=t,c=c.replace(p,""));else if(m.test(c)){m=m.exec(c);var r=m[1];m=f;if(m.test(r)){c=r;m=y;var x=u;m.test(c)?c+="e":x.test(c)?(p=t,c=c.replace(p,"")):q.test(c)&&(c+="e")}}p=v;p.test(c)&&(m=p.exec(c),r=m[1],c=r+"i");p=z;p.test(c)&&(m=p.exec(c),r=m[1],m=m[2],p=d,p.test(r)&&
(c=r+a[m]));p=A;p.test(c)&&(m=p.exec(c),r=m[1],m=m[2],p=d,p.test(r)&&(c=r+b[m]));p=F;m=D;p.test(c)?(m=p.exec(c),r=m[1],p=g,p.test(r)&&(c=r)):m.test(c)&&(m=m.exec(c),r=m[1]+m[2],m=g,m.test(r)&&(c=r));p=B;p.test(c)&&(m=p.exec(c),r=m[1],p=g,m=e,x=C,p.test(r)||m.test(r)&&!x.test(r))&&(c=r);p=E;m=g;p.test(c)&&m.test(c)&&(p=t,c=c.replace(p,""));"y"==w&&(c=w.toLowerCase()+c.substr(1));return c};return function(a){return a.update(x)}}();b.Pipeline.registerFunction(b.stemmer,"stemmer");b.generateStopWordFilter=
...
new b.Vector;a.call(c,c);for(k=0;k<c.clauses.length;k++){var l=c.clauses[k],n=null;n=l.usePipeline?this.pipeline.runString(l.term,{fields:l.fields}):[l.term];for(var t=0;t<n.length;t++){l.term=n[t];a=b.TokenSet.fromClause(l);var y=this.tokenSet.intersect(a).toArray();if(0===y.length&&l.presence===b.Query.presence.REQUIRED){for(var u=0;u<l.fields.length;u++){var q=l.fields[u];f[q]=b.Set.empty}break}for(var v=0;v<y.length;v++){var z=y[v],A=this.invertedIndex[z],F=A._index;for(u=0;u<l.fields.length;u++){q=
l.fields[u];var D=A[q],B=Object.keys(D),E=z+"/"+q;a=new b.Set(B);l.presence==b.Query.presence.REQUIRED&&(void 0===f[q]&&(f[q]=b.Set.complete),f[q]=f[q].intersect(a));if(l.presence==b.Query.presence.PROHIBITED)void 0===h[q]&&(h[q]=b.Set.empty),h[q]=h[q].union(a);else if(g[q].upsert(F,1*l.boost,function(a,b){return a+b}),!e[E]){for(var C=0;C<B.length;C++){var x=B[C];a=new b.FieldRef(x,q);x=D[x];var w;void 0===(w=d[a])?d[a]=new b.MatchData(z,q,x):w.add(z,q,x)}e[E]=!0}}}}}e=b.Set.complete;w=b.Set.empty;
for(k=0;k<this.fields.length;k++)q=this.fields[k],f[q]&&(e=e.union(f[q])),h[q]&&(w=w.union(h[q]));f=Object.keys(d);h=[];q=Object.create(null);if(c.isNegated())for(f=Object.keys(this.fieldVectors),k=0;k<f.length;k++)a=f[k],c=b.FieldRef.fromString(a),d[a]=new b.MatchData;for(k=0;k<f.length;k++)c=b.FieldRef.fromString(f[k]),a=c.docRef,e.contains(a)&&!w.contains(a)&&(l=g[c.fieldName].similarity(this.fieldVectors[c]),void 0!==(n=q[a])?(n.score+=l,n.matchData.combine(d[c])):(c={ref:a,score:l,matchData:d[c]},
q[a]=c,h.push(c)));return h.sort(function(a,b){return b.score-a.score})};b.Index.prototype.toJSON=function(){var a=Object.keys(this.invertedIndex).sort().map(function(a){return[a,this.invertedIndex[a]]},this),c=Object.keys(this.fieldVectors).map(function(a){return[a,this.fieldVectors[a].toJSON()]},this);return{version:b.version,fields:this.fields,fieldVectors:c,invertedIndex:a,pipeline:this.pipeline.toJSON()}};b.Index.load=function(a){var c={},d={},g=a.fieldVectors,e={},f=a.invertedIndex,h=new b.TokenSet.Builder,
k=b.Pipeline.load(a.pipeline);a.version!=b.version&&b.utils.warn("Version mismatch when loading serialised index. Current version of lunr '"+b.version+"' does not match serialized index '"+a.version+"'");for(var l=0;l<g.length;l++){var n=g[l];d[n[0]]=new b.Vector(n[1])}for(l=0;l<f.length;l++)n=f[l],g=n[0],n=n[1],h.insert(g),e[g]=n;h.finish();c.fields=a.fields;c.fieldVectors=d;c.invertedIndex=e;c.tokenSet=h.root;c.pipeline=k;return new b.Index(c)};b.Builder=function(){this._ref="id";this._fields=[];
this.invertedIndex=Object.create(null);this.fieldTermFrequencies={};this.fieldLengths={};this.tokenizer=b.tokenizer;this.pipeline=new b.Pipeline;this.searchPipeline=new b.Pipeline;this.documentCount=0;this._b=.75;this._k1=1.2;this.termIndex=0;this.metadataWhitelist=[]};b.Builder.prototype.ref=function(a){this._ref=a};b.Builder.prototype.field=function(a){this._fields.push(a)};b.Builder.prototype.b=function(a){this._b=0>a?0:1<a?1:a};b.Builder.prototype.k1=function(a){this._k1=a};b.Builder.prototype.add=
function(a){var c=a[this._ref];this.documentCount+=1;for(var d=0;d<this._fields.length;d++){var g=this._fields[d],e=this.tokenizer(a[g],{fields:[g]});e=this.pipeline.run(e);var f=new b.FieldRef(c,g),h=Object.create(null);this.fieldTermFrequencies[f]=h;this.fieldLengths[f]=0;this.fieldLengths[f]+=e.length;for(f=0;f<e.length;f++){var k=e[f];void 0==h[k]&&(h[k]=0);h[k]+=1;if(void 0==this.invertedIndex[k]){var l=Object.create(null);l._index=this.termIndex;this.termIndex+=1;for(var n=0;n<this._fields.length;n++)l[this._fields[n]]=
Object.create(null);this.invertedIndex[k]=l}void 0==this.invertedIndex[k][g][c]&&(this.invertedIndex[k][g][c]=Object.create(null));for(l=0;l<this.metadataWhitelist.length;l++){n=this.metadataWhitelist[l];var t=k.metadata[n];void 0==this.invertedIndex[k][g][c][n]&&(this.invertedIndex[k][g][c][n]=[]);this.invertedIndex[k][g][c][n].push(t)}}}};b.Builder.prototype.calculateAverageFieldLengths=function(){for(var a=Object.keys(this.fieldLengths),c=a.length,d={},g={},e=0;e<c;e++){var f=b.FieldRef.fromString(a[e]),
h=f.fieldName;g[h]||(g[h]=0);g[h]+=1;d[h]||(d[h]=0);d[h]+=this.fieldLengths[f]}for(e=0;e<this._fields.length;e++)h=this._fields[e],d[h]/=g[h];this.averageFieldLength=d};b.Builder.prototype.createFieldVectors=function(){for(var a={},c=Object.keys(this.fieldTermFrequencies),d=c.length,g=Object.create(null),e=0;e<d;e++){for(var f=b.FieldRef.fromString(c[e]),h=f.fieldName,k=this.fieldLengths[f],l=new b.Vector,n=this.fieldTermFrequencies[f],t=Object.keys(n),y=t.length,u=0;u<y;u++){var q=t[u],v=n[q],z=
this.invertedIndex[q]._index;if(void 0===g[q]){var A=b.idf(this.invertedIndex[q],this.documentCount);g[q]=A}else A=g[q];l.insert(z,Math.round(A*(this._k1+1)*v/(this._k1*(1-this._b+k/this.averageFieldLength[h]*this._b)+v)*1E3)/1E3)}a[f]=l}this.fieldVectors=a};b.Builder.prototype.createTokenSet=function(){this.tokenSet=b.TokenSet.fromArray(Object.keys(this.invertedIndex).sort())};b.Builder.prototype.build=function(){this.calculateAverageFieldLengths();this.createFieldVectors();this.createTokenSet();
return new b.Index({invertedIndex:this.invertedIndex,fieldVectors:this.fieldVectors,tokenSet:this.tokenSet,fields:this._fields,pipeline:this.searchPipeline})};b.Builder.prototype.use=function(a){var b=Array.prototype.slice.call(arguments,1);b.unshift(this);a.apply(this,b)};b.MatchData=function(a,b,d){for(var c=Object.create(null),e=Object.keys(d||{}),f=0;f<e.length;f++){var h=e[f];c[h]=d[h].slice()}this.metadata=Object.create(null);void 0!==a&&(this.metadata[a]=Object.create(null),this.metadata[a][b]=
c)};b.MatchData.prototype.combine=function(a){for(var b=Object.keys(a.metadata),d=0;d<b.length;d++){var g=b[d],e=Object.keys(a.metadata[g]);void 0==this.metadata[g]&&(this.metadata[g]=Object.create(null));for(var f=0;f<e.length;f++){var h=e[f],k=Object.keys(a.metadata[g][h]);void 0==this.metadata[g][h]&&(this.metadata[g][h]=Object.create(null));for(var l=0;l<k.length;l++){var n=k[l];this.metadata[g][h][n]=void 0==this.metadata[g][h][n]?a.metadata[g][h][n]:this.metadata[g][h][n].concat(a.metadata[g][h][n])}}}};
b.MatchData.prototype.add=function(a,b,d){if(a in this.metadata)if(b in this.metadata[a])for(var c=Object.keys(d),e=0;e<c.length;e++){var f=c[e];this.metadata[a][b][f]=f in this.metadata[a][b]?this.metadata[a][b][f].concat(d[f]):d[f]}else this.metadata[a][b]=d;else this.metadata[a]=Object.create(null),this.metadata[a][b]=d};b.Query=function(a){this.clauses=[];this.allFields=a};b.Query.wildcard=new String("*");b.Query.wildcard.NONE=0;b.Query.wildcard.LEADING=1;b.Query.wildcard.TRAILING=2;b.Query.presence=
{OPTIONAL:1,REQUIRED:2,PROHIBITED:3};b.Query.prototype.clause=function(a){"fields"in a||(a.fields=this.allFields);"boost"in a||(a.boost=1);"usePipeline"in a||(a.usePipeline=!0);"wildcard"in a||(a.wildcard=b.Query.wildcard.NONE);a.wildcard&b.Query.wildcard.LEADING&&a.term.charAt(0)!=b.Query.wildcard&&(a.term="*"+a.term);a.wildcard&b.Query.wildcard.TRAILING&&a.term.slice(-1)!=b.Query.wildcard&&(a.term=""+a.term+"*");"presence"in a||(a.presence=b.Query.presence.OPTIONAL);this.clauses.push(a);return this};
b.Query.prototype.isNegated=function(){for(var a=0;a<this.clauses.length;a++)if(this.clauses[a].presence!=b.Query.presence.PROHIBITED)return!1;return!0};b.Query.prototype.term=function(a,b){if(Array.isArray(a))return a.forEach(function(a){this.term(a,b)},this),this;var c=b||{};c.term=a.toString();this.clause(c);return this};b.QueryParseError=function(a,b,d){this.name="QueryParseError";this.message=a;this.start=b;this.end=d};b.QueryParseError.prototype=Error();b.QueryLexer=function(a){this.lexemes=
[];this.str=a;this.length=a.length;this.start=this.pos=0;this.escapeCharPositions=[]};b.QueryLexer.prototype.run=function(){for(var a=b.QueryLexer.lexText;a;)a=a(this)};b.QueryLexer.prototype.sliceString=function(){for(var a=[],b=this.start,d,g=0;g<this.escapeCharPositions.length;g++)d=this.escapeCharPositions[g],a.push(this.str.slice(b,d)),b=d+1;a.push(this.str.slice(b,this.pos));this.escapeCharPositions.length=0;return a.join("")};b.QueryLexer.prototype.emit=function(a){this.lexemes.push({type:a,
str:this.sliceString(),start:this.start,end:this.pos});this.start=this.pos};b.QueryLexer.prototype.escapeCharacter=function(){this.escapeCharPositions.push(this.pos-1);this.pos+=1};b.QueryLexer.prototype.next=function(){if(this.pos>=this.length)return b.QueryLexer.EOS;var a=this.str.charAt(this.pos);this.pos+=1;return a};b.QueryLexer.prototype.width=function(){return this.pos-this.start};b.QueryLexer.prototype.ignore=function(){this.start==this.pos&&(this.pos+=1);this.start=this.pos};b.QueryLexer.prototype.backup=
function(){--this.pos};b.QueryLexer.prototype.acceptDigitRun=function(){do{var a=this.next();var c=a.charCodeAt(0)}while(47<c&&58>c);a!=b.QueryLexer.EOS&&this.backup()};b.QueryLexer.prototype.more=function(){return this.pos<this.length};b.QueryLexer.EOS="EOS";b.QueryLexer.FIELD="FIELD";b.QueryLexer.TERM="TERM";b.QueryLexer.EDIT_DISTANCE="EDIT_DISTANCE";b.QueryLexer.BOOST="BOOST";b.QueryLexer.PRESENCE="PRESENCE";b.QueryLexer.lexField=function(a){a.backup();a.emit(b.QueryLexer.FIELD);a.ignore();return b.QueryLexer.lexText};
b.QueryLexer.lexTerm=function(a){1<a.width()&&(a.backup(),a.emit(b.QueryLexer.TERM));a.ignore();if(a.more())return b.QueryLexer.lexText};b.QueryLexer.lexEditDistance=function(a){a.ignore();a.acceptDigitRun();a.emit(b.QueryLexer.EDIT_DISTANCE);return b.QueryLexer.lexText};b.QueryLexer.lexBoost=function(a){a.ignore();a.acceptDigitRun();a.emit(b.QueryLexer.BOOST);return b.QueryLexer.lexText};b.QueryLexer.lexEOS=function(a){0<a.width()&&a.emit(b.QueryLexer.TERM)};b.QueryLexer.termSeparator=b.tokenizer.separator;
b.QueryLexer.lexText=function(a){for(;;){var c=a.next();if(c==b.QueryLexer.EOS)return b.QueryLexer.lexEOS;if(92==c.charCodeAt(0))a.escapeCharacter();else{if(":"==c)return b.QueryLexer.lexField;if("~"==c)return a.backup(),0<a.width()&&a.emit(b.QueryLexer.TERM),b.QueryLexer.lexEditDistance;if("^"==c)return a.backup(),0<a.width()&&a.emit(b.QueryLexer.TERM),b.QueryLexer.lexBoost;if("+"==c&&1===a.width()||"-"==c&&1===a.width())return a.emit(b.QueryLexer.PRESENCE),b.QueryLexer.lexText;if(c.match(b.QueryLexer.termSeparator))return b.QueryLexer.lexTerm}}};
b.QueryParser=function(a,c){this.lexer=new b.QueryLexer(a);this.query=c;this.currentClause={};this.lexemeIdx=0};b.QueryParser.prototype.parse=function(){this.lexer.run();this.lexemes=this.lexer.lexemes;for(var a=b.QueryParser.parseClause;a;)a=a(this);return this.query};b.QueryParser.prototype.peekLexeme=function(){return this.lexemes[this.lexemeIdx]};b.QueryParser.prototype.consumeLexeme=function(){var a=this.peekLexeme();this.lexemeIdx+=1;return a};b.QueryParser.prototype.nextClause=function(){this.query.clause(this.currentClause);
this.currentClause={}};b.QueryParser.parseClause=function(a){a=a.peekLexeme();if(void 0!=a)switch(a.type){case b.QueryLexer.PRESENCE:return b.QueryParser.parsePresence;case b.QueryLexer.FIELD:return b.QueryParser.parseField;case b.QueryLexer.TERM:return b.QueryParser.parseTerm;default:var c="expected either a field or a term, found "+a.type;1<=a.str.length&&(c+=" with value '"+a.str+"'");throw new b.QueryParseError(c,a.start,a.end);}};b.QueryParser.parsePresence=function(a){var c=a.consumeLexeme();
if(void 0!=c){switch(c.str){case "-":a.currentClause.presence=b.Query.presence.PROHIBITED;break;case "+":a.currentClause.presence=b.Query.presence.REQUIRED;break;default:throw a="unrecognised presence operator'"+c.str+"'",new b.QueryParseError(a,c.start,c.end);}var d=a.peekLexeme();if(void 0==d)throw new b.QueryParseError("expecting term or field, found nothing",c.start,c.end);switch(d.type){case b.QueryLexer.FIELD:return b.QueryParser.parseField;case b.QueryLexer.TERM:return b.QueryParser.parseTerm;
default:throw a="expecting term or field, found '"+d.type+"'",new b.QueryParseError(a,d.start,d.end);}}};b.QueryParser.parseField=function(a){var c=a.consumeLexeme();if(void 0!=c){if(-1==a.query.allFields.indexOf(c.str))throw a=a.query.allFields.map(function(a){return"'"+a+"'"}).join(", "),a="unrecognised field '"+c.str+"', possible fields: "+a,new b.QueryParseError(a,c.start,c.end);a.currentClause.fields=[c.str];var d=a.peekLexeme();if(void 0==d)throw new b.QueryParseError("expecting term, found nothing",
c.start,c.end);switch(d.type){case b.QueryLexer.TERM:return b.QueryParser.parseTerm;default:throw a="expecting term, found '"+d.type+"'",new b.QueryParseError(a,d.start,d.end);}}};b.QueryParser.parseTerm=function(a){var c=a.consumeLexeme();if(void 0!=c)if(a.currentClause.term=c.str.toLowerCase(),-1!=c.str.indexOf("*")&&(a.currentClause.usePipeline=!1),c=a.peekLexeme(),void 0==c)a.nextClause();else switch(c.type){case b.QueryLexer.TERM:return a.nextClause(),b.QueryParser.parseTerm;case b.QueryLexer.FIELD:return a.nextClause(),
b.QueryParser.parseField;case b.QueryLexer.EDIT_DISTANCE:return b.QueryParser.parseEditDistance;case b.QueryLexer.BOOST:return b.QueryParser.parseBoost;case b.QueryLexer.PRESENCE:return a.nextClause(),b.QueryParser.parsePresence;default:throw new b.QueryParseError("Unexpected lexeme type '"+c.type+"'",c.start,c.end);}};b.QueryParser.parseEditDistance=function(a){var c=a.consumeLexeme();if(void 0!=c){var d=parseInt(c.str,10);if(isNaN(d))throw new b.QueryParseError("edit distance must be numeric",c.start,
